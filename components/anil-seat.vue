  ...
  <view class="sel-seat">
    ...
    <view class="seat-main">
            ...
            class="sm-cell" :style="'width:'+boxWidth+'px;height:'+seatSize+'px'">
          	<view v-for="(seat,col) in item" :key="col" class="dp-ib" :style="'width:'+seatSize+'px;height:'+seatSize+'px'"
          	 @click="handleChooseSeat(index,col)">
          		<image v-if="seat.type===0" class="sm-icon" src="https://hijinka.oss-cn-shanghai.aliyuncs.com/uploads/mall1/20220307/669dde5d9fe28a377c151cadecb8dd65.png" mode="aspectFit"></image>
          		<image v-else-if="seat.type===1" class="sm-icon" src="https://hijinka.oss-cn-shanghai.aliyuncs.com/uploads/mall1/20220307/899c7f9e0365ce6d97f9d5fe89ffe878.png" mode="aspectFit"></image>
          		<image v-else-if="seat.type===2" class="sm-icon" src="https://hijinka.oss-cn-shanghai.aliyuncs.com/uploads/mall1/20220307/123044531581e70133020f0265bcabb2.png" mode="aspectFit"></image>
          	</view>
          </view>
      ...
      <view class="fix-tips" v-if="showTis">
      	<view class="v-tips">
      		<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="https://hijinka.oss-cn-shanghai.aliyuncs.com/uploads/mall1/20220307/669dde5d9fe28a377c151cadecb8dd65.png" mode="aspectFit"></image>
          <text class="text">可选</text>
      	</view>
      	<view class="v-tips">
      		<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="https://hijinka.oss-cn-shanghai.aliyuncs.com/uploads/mall1/20220307/123044531581e70133020f0265bcabb2.png" mode="aspectFit"></image>
          <text class="text">不可选</text>
      	</view>
      	<view class="v-tips">
      		<image :style="'width:'+seatSize+'px;height:'+seatSize+'px'" src="https://hijinka.oss-cn-shanghai.aliyuncs.com/uploads/mall1/20220307/899c7f9e0365ce6d97f9d5fe89ffe878.png" mode="aspectFit"></image>
